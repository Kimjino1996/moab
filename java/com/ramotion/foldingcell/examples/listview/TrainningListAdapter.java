...
public class TrainningListAdapter extends BaseAdapter {

    LayoutInflater inflater = null;
    private ArrayList<TrainningItem> m_oData = null;
    private int nListCnt = 0;

    public TrainningListAdapter(ArrayList<TrainningItem> _oData)
    {
        m_oData = _oData;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null)
        {
            ...
            convertView = inflater.inflate(R.layout.trainning_item, parent, false);
        }
